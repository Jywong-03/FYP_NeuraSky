...
export default function LiveFlightMap({ flights: userFlights = [] }) {
  ...
  return (
    <div className="w-full h-full relative z-0"> 
      ...
      <div className="absolute bottom-4 right-4 z-1000 flex flex-col gap-2 items-end pointer-events-auto">
            {/* Demo Toggle */}
            <div 
                className="bg-white/95 p-3 rounded-lg shadow-lg border border-slate-200 backdrop-blur-sm"
            >
